...
export const DICT = {
  ...
  /* Popup (DialogProvider) — admin bhi yahin se padhta hai */
  dialogOk: { en: 'OK', hi: 'ठीक है' },
  dialogCancel: { en: 'Cancel', hi: 'रद्द करें' },
  dialogConfirm: { en: 'Yes, continue', hi: 'हाँ, आगे बढ़ें' },
  dialogDelete: { en: 'Yes, delete', hi: 'हाँ, हटाएं' },
  dialogWorking: { en: 'Please wait…', hi: 'रुकिए…' },
  dialogFailed: { en: "Couldn't do that — please try again", hi: 'नहीं हो पाया — दोबारा कोशिश करें' },
  cannotUndo: { en: 'This cannot be undone.', hi: 'यह वापस नहीं आएगा।' }
};
