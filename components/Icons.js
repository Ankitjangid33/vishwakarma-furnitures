...
const PATHS = {
  ...
  eyeOff: (
    <>
      <path {...s} d="M10.6 6.7A8.9 8.9 0 0 1 12 6.5c6 0 9.5 5.5 9.5 5.5a17 17 0 0 1-3 3.6M6.4 8.1A16.8 16.8 0 0 0 2.5 12S6 17.5 12 17.5c1.3 0 2.5-.3 3.5-.7" />
      <path {...s} d="M9.9 9.9a3 3 0 0 0 4.2 4.2M3 3l18 18" />
    </>
  ),
  grid: (
    <>
